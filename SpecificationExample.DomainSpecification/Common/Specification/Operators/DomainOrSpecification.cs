...
public class DomainOrSpecification<T> : DomainSpecification<T> where T : Entity
{
    ...
    private static Expression<Func<T, bool>>? CombineRule(DomainSpecification<T>? left, DomainSpecification<T>? right)
    {
        ...
        return ExpressionCombiner.CombineExpressions(leftExpresssion, rightExpression, Expression.OrElse);
    }
