...
public class WhenUsingAndSpecification
{
    ...
    {
        var act = () => new DomainAndSpecification<TestEntity>(null!, null!);
    ...
    private class TestEntityByValueGreaterThanWithPagingSpecification : DomainSpecification<TestEntity>
    {
